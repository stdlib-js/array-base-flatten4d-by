...
```javascript
flatten4dBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d-by@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten4d-by@v0.1.0-umd/browser.js"></script>
```
